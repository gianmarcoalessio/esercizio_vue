...
export default {
    ...
    //emits: ["update:name", "update:username", "update:modelValue"],
    methods: {
    changeValue(m,t) {
      console.log(m,t.target);
      this.$emit(`update:${m}`,t.target.value);
    },
    changeP(t) {
      console.log(t.target);
      this.$emit(`update:modelValue`,t.target.innerText);
